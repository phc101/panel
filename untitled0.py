...
if data.empty:
    ...
    # Ensure rolling columns exist before dropping NaN
    if 'Mean_20' in data.columns and 'Std_20' in data.columns:
        ...
        st.error("Rolling calculations failed. Please ensure the data contains enough rows for a 20-day window.")
