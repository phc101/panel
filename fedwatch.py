...
2025-01,4.9,5.75,4.2130,4.0900
2025-02,4.9,5.75,4.1750,4.0050
2025-03,4.9,5.75,4.1850,3.8700
2025-04,4.3,5.75,4.2700,3.7750
2025-05,4.0,5.25,4.2550,3.7800
2025-06,4.1,5.25,4.2700,3.7100
2025-07,3.1,5.00,4.2600,3.6400
2025-08,2.9,5.00,4.2600,3.6600
2025-09,2.9,4.75,4.2600,3.6200
2025-10,2.8,4.50,4.2500,3.6600
2025-11,2.7,4.25,4.2400,3.6700
2025-12,3.1,4.00,4.2300,3.6200
2026-01,2.9,4.00,4.2200,3.6100
2026-02,2.4,4.00,4.2300,3.6400
2026-03,3.0,3.75,4.2500,3.6900
2026-04,3.2,3.75,4.2700,3.7300
2026-05,3.1,3.75,4.2700,3.7400
2026-06,2.5,3.75,4.2800,3.7500"""
...
US_RATE_STEPS = [
    ...
    ("2024-12", 4.375), ("2025-09", 4.125), ("2025-10", 3.875),
    ("2025-12", 3.625),
]
ECB_RATE_STEPS = [
    ...
    ("2025-03", 2.50), ("2025-04", 2.25), ("2025-06", 2.00),
    ("2026-06", 2.25),
]
US_BKEVEN_ANCHORS = [
    ...
    ("2024-12", 2.30), ("2025-05", 2.30), ("2025-12", 2.35),
    ("2026-03", 2.45), ("2026-06", 2.55),
]
EA_HICP_ANCHORS = [
    ...
    ("2025-09", 2.2), ("2025-12", 2.0), ("2026-01", 1.7),
    ("2026-02", 1.9), ("2026-03", 2.6), ("2026-04", 3.0),
    ("2026-05", 3.2), ("2026-06", 2.8),
]
...
src = st.sidebar.radio("Źródło danych", ["Wbudowane (2014–06.2026)", "Upload CSV"])
csv_bytes = None
if src == "Upload CSV":
