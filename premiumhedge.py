...
# Industry options
INDUSTRY_OPTIONS = {
    "Manufacturing": "manufacturing OR produkcja OR fabryka OR produkcyjna",
    "Food & Beverages": "food OR beverages OR żywność OR napoje OR eksport żywności",
    "Automotive": "automotive OR car parts OR motoryzacja OR części samochodowe",
    "Textiles": "textiles OR clothing OR odzież OR tkaniny OR moda",
    "Chemicals": "chemicals OR chemical industry OR chemia OR przemysł chemiczny",
...
# Function to check if a website contains KRS or NIP (indicating a business)
        ...
        try:
            ...
            for url in new_results:
                if len(valid_companies) >= 10:
                    break  # Stop when we have 10 valid companies
